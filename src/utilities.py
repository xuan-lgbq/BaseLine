...
def get_directory(dataset: str, arch_id: float, loss: float, seed: int, opt: str, lr: float, beta: float, rho: float, batch_size: int):
    results_dir = os.environ["/jumbo/yaoqingyang/boyao/mnist_result"]
...
def get_proj_directory(proj:str, dataset: str, arch_id: float, loss: float, seed: int, opt: str, lr: float, beta: float, rho: float, batch_size: int, start_step: int):
